    ...
    <aside className="w-80 bg-white border-r border-slate-200 flex flex-col h-full select-none z-20 shadow-sm">
      ...
      {activeTab === "library" ? (
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
          ...
          <div>
            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2.5">Photos & Médias</p>
            <div className="grid grid-cols-2 gap-2">
              ...
              <button
                ...
                className="p-2.5 bg-slate-50 hover:bg-indigo-50/60 border border-slate-200 hover:border-indigo-300 rounded-xl flex flex-col items-center gap-1.5 text-slate-800 transition group"
              >
              ...
              <button
                ...
                className="p-2.5 bg-slate-50 hover:bg-indigo-50/60 border border-slate-200 hover:border-indigo-300 rounded-xl flex flex-col items-center gap-1.5 text-slate-800 transition group"
              >
                <Shield size={18} className="text-purple-600 group-hover:scale-110 transition-transform" />
          ...
          <div>
            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2.5">Formes, Badges & Cadres</p>
              ...
              >
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[9px] px-1.5 py-0.5 bg-slate-200 rounded text-slate-600 font-semibold">{item.category}</span>
                  </div>
          ...
          {ICON_CATALOG.map((cat) => {
            ...
            return (
              <div key={cat.category} className="space-y-2">
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">{cat.category}</p>
                <div className="grid grid-cols-3 gap-2">
                  {items.map((ic) => {
                    ...
                    return (
                      <button
                        ...
                        className="p-2.5 bg-slate-50 hover:bg-indigo-50 border border-slate-200 rounded-xl flex flex-col items-center gap-1 text-slate-700 transition group"
                      >
                        <IconComp size={18} className="text-indigo-600 group-hover:scale-110 transition-transform" />
